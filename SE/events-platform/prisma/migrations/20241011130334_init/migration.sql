/*
  ...
  - You are about to alter the column `priceInPence` on the `Event` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
